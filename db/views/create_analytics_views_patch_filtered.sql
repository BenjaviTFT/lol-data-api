-- ============================================================
-- VUES ANALYTICS FILTREES PAR PATCH 16.1 + DATE >= 08/01/2026
-- Ces vues remplacent les vues d'origine avec un filtre sur patch_version et date
-- ============================================================

-- Suppression des vues existantes pour recréation propre
DROP VIEW IF EXISTS riot_analytics.recent_matches CASCADE;
DROP VIEW IF EXISTS riot_analytics.popular_items CASCADE;
DROP VIEW IF EXISTS riot_analytics.player_stats_by_role CASCADE;
DROP VIEW IF EXISTS riot_analytics.player_ranking CASCADE;
DROP VIEW IF EXISTS riot_analytics.duoq_synergies CASCADE;
DROP VIEW IF EXISTS riot_analytics.player_champions CASCADE;
DROP VIEW IF EXISTS riot_analytics.player_stats CASCADE;

CREATE SCHEMA IF NOT EXISTS riot_analytics;

-- ============================================================
-- VUE 1 : STATS PAR JOUEUR (filtre patch 16.1)
-- ============================================================
...
-- ============================================================
-- VUE 2 : CHAMPIONS JOUES PAR JOUEUR (filtre patch 16.1)
-- ============================================================
...
-- ============================================================
-- VUE 4 : RANKING INTERNE (filtre patch 16.1)
-- ============================================================
...
-- ============================================================
-- VUE 5 : STATS PAR ROLE (filtre patch 16.1)
-- ============================================================
...
-- ============================================================
-- VUE 6 : ITEMS POPULAIRES (filtre patch 16.1)
-- ============================================================
...
-- ============================================================
-- VUE 7 : HISTORIQUE RECENT (filtre patch 16.1)
-- ============================================================
...
SELECT
    ...
    mg.game_duration,
    mg.patch_version,
    dp.summoner_name AS player_name,
